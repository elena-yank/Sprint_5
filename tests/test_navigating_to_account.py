...
class TestPersonalAccount:
    ...
    # Переход в Личный кабинет. Для этого сначала нужно залогиниться
    def test_open_account_info_successful(self, driver):
        ...
        # Проверяем, что активная ссылка совпадает с адресом Личного кабинета
        assert driver.current_url == TestLinks.ACCOUNT_PAGE